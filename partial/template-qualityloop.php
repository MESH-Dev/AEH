			...
			<ul class="clearfix">
				...
				<?php } } wp_reset_query(); ?>
							...
							<div class="item">
			    				...
			    				<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
			    				<p><span class="item-date"><?php echo date('M j, Y', get_field('webinar_date')); ?></span></p>
					    		...
					    		<p><span class="reserve button greenn quality"><a href="<?php the_field('registration_link'); ?>">Reserve Your Spot</a></span></p>
						...
						<?php endwhile; wp_reset_query();?>
							...
							<div class="item">
				    			...
				    			<?php if(get_field('link_to_media')){ ?>
									<p><a href="<?php the_field('uploaded_file'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/<?php echo $postType; ?>-doc.png" /></a></p>
									<?php }else{ ?>
										<p><?php
										$exc = get_the_excerpt();
										$line=$exc;
